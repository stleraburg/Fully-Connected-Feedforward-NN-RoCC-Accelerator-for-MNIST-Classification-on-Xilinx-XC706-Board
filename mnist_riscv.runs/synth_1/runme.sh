...
HD_PWD='C:/Users/stleraburg/mnist_riscv/mnist_riscv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_core.tcl
