...
namespace eval ::optrace {
  variable script "C:/Users/stleraburg/mnist_riscv/mnist_riscv.runs/impl_1/riscv_core.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/Users/stleraburg/mnist_riscv/mnist_riscv.runs/synth_1/riscv_core.dcp
...
OPTRACE "link_design" START { }
  link_design -top riscv_core -part xc7z045ffg900-2 
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file riscv_core_timing_summary_routed.rpt -pb riscv_core_timing_summary_routed.pb -rpx riscv_core_timing_summary_routed.rpx -warn_on_violation "
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  catch { write_mem_info -force -no_partial_mmi riscv_core.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force riscv_core.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force riscv_core}
  catch {file copy -force riscv_core.ltx debug_nets.ltx}
