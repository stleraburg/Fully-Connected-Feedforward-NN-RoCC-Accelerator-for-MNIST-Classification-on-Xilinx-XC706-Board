...
REM
REM Generated by Vivado on Thu Jul 23 14:51:52 +0500 2026
...
echo "xvlog --incr --relax -prj tb_riscv_rx_vlog.prj"
call xvlog  --incr --relax -prj tb_riscv_rx_vlog.prj -log xvlog.log
